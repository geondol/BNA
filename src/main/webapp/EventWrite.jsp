...
<body>
	<form action="EventWritePro.jsp" method="post">
		<table border="1" style="margin-top: 50px;">
			<tr>
			 	<td colspan="2" style="padding:20px; background-color: #0066FF; font-size: 30px; color: white;">이벤트 글쓰기</td>
		 	</tr>
		 	<tr>
		 	...
		 	<tr>
		 		<td colspan="2" style="padding: 20px;">
			 		...
			 		<input style="font-size: 20px; padding: 5px;" type="button" value="이벤트 전체" onclick="location.href='index.jsp?main=Event.jsp'">
